...
class Drawer:
    @staticmethod
    def plot_dependency(LMM: LinearMultipleMeasurement, **kwargs):
        Drawer.plot_MKN(LMM.a, LMM.b, LMM.measurments_X, LMM.measurments_Y, **kwargs)
    ...
    def plot_MKN(
            ...
            error_X=False, error_Y=False, output_path=None
        ):
        if label is None:
        ...
        Y_theor = nA.value + X_range * nB.value
