...
# iBGP RR
/routing bgp instance set default as=65000 router-id=10.0.0.33 redistribute-connected=yes

/routing bgp peer
# Cluster RR
add name=to_HKI remote-address=10.0.0.11 remote-as=65000 update-source=lo0 address-families=vpnv4
add name=to_LND remote-address=10.0.0.22 remote-as=65000 update-source=lo0 address-families=vpnv4
# Client (SVL)
add name=to_SVL remote-address=10.0.0.30 remote-as=65000 update-source=lo0 route-reflect=yes address-families=vpnv4