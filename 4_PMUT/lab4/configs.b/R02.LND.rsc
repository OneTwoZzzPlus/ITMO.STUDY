...
# iBGP RR
/routing bgp instance set default as=65000 router-id=10.0.0.22 redistribute-connected=yes client-to-client-reflection=yes

/routing bgp peer
# Cluster RR
add name=to_HKI remote-address=10.0.0.11 remote-as=65000 update-source=lo0 address-families=vpnv4,l2vpn
add name=to_LBN remote-address=10.0.0.33 remote-as=65000 update-source=lo0 address-families=vpnv4,l2vpn
# Client (NYD)
add name=to_NYD remote-address=10.0.0.20 remote-as=65000 update-source=lo0 route-reflect=yes address-families=vpnv4,l2vpn